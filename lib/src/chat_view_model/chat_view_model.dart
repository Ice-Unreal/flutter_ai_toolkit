...
class ChatViewModel {
  ...
  /// [LlmStreamGenerator] for sending messages. [aiDescription] is an optional
  /// description text that will be appended to each LLM message.
  const ChatViewModel({
    ...
    this.aiDescription = "以上输出由AI生成，仅供参考。",
  });
  ...
  /// The description text that will be appended to each LLM message.
  ///
  /// This text is typically used to indicate that the message was generated by AI.
